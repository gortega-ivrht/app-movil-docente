...
class OldUserDao(context: Context){
        ...
        fun getAllUsers(): List<OldUser>{
            ...
            if (cursor.moveToFirst()){
                do {
                    ...
                    users.add(OldUser(id,name,email,phone,password))
    ...
    fun getUsersFilter(nameFilter: String): List<OldUser>{
        val db = dbHelper.readableDatabase
        val users = mutableListOf<OldUser>()
